...
**Timeline visualisation of MVCC:**

<figure class="diagram fig-mvcc">
<svg viewBox="0 0 680 530" role="img" aria-labelledby="mvcc-title mvcc-desc">
<title id="mvcc-title">MVCC timeline: a reader and a writer on the same row</title>
<desc id="mvcc-desc">Transaction 1 opens a snapshot at T1 and keeps reading version v1 of the row. Transaction 2 updates the row at T4, creating version v2, and commits at T5. Transaction 1 still reads v1 at T6 because v1 is retained for its snapshot. A transaction starting after T7 reads v2.</desc>
<text class="d-head" x="46" y="24">TRANSACTION 1 · READER</text>
<text class="d-head" x="250" y="24">TRANSACTION 2 · WRITER</text>
<text class="d-head" x="424" y="24">ROW VERSIONS</text>
<line class="d-rule" x1="8" y1="38" x2="672" y2="38"/>
<line class="d-life" x1="141" y1="122" x2="141" y2="434"/>
<line class="d-life" x1="330" y1="226" x2="330" y2="330"/>
<text class="d-time" x="30" y="74" text-anchor="end">T0</text>
<text class="d-time" x="30" y="126" text-anchor="end">T1</text>
<text class="d-time" x="30" y="178" text-anchor="end">T2</text>
<text class="d-time" x="30" y="230" text-anchor="end">T3</text>
<text class="d-time" x="30" y="282" text-anchor="end">T4</text>
<text class="d-time" x="30" y="334" text-anchor="end">T5</text>
<text class="d-time" x="30" y="386" text-anchor="end">T6</text>
<text class="d-time" x="30" y="438" text-anchor="end">T7</text>
<text class="d-time" x="30" y="490" text-anchor="end">T8</text>
<rect class="d-v1" x="424" y="58" width="11" height="274" rx="5"/>
<rect class="d-v1-old" x="424" y="326" width="11" height="120" rx="5"/>
<rect class="d-v2-pend" x="449" y="266" width="11" height="68" rx="5"/>
<rect class="d-v2" x="449" y="326" width="11" height="184" rx="5"/>
<text class="d-label" x="474" y="66">v1 · price = 10</text>
<text class="d-label" x="474" y="274">v2 · price = 20</text>
<text class="d-note" x="474" y="290">created, not yet visible</text>
<text class="d-note" x="474" y="342">committed — now current</text>
<text class="d-emph" x="474" y="394">v1 kept alive for</text>
<text class="d-note" x="474" y="408">Transaction 1's snapshot</text>
<text class="d-note" x="474" y="494">a new transaction</text>
<text class="d-note" x="474" y="508">starting here reads v2</text>
<rect class="d-box r" x="46" y="105" width="190" height="34" rx="5"/>
<text class="d-label" x="141" y="126" text-anchor="middle">BEGIN — snapshot at T1</text>
<rect class="d-box r" x="46" y="157" width="190" height="34" rx="5"/>
<text class="d-label" x="141" y="178" text-anchor="middle">SELECT → price = 10</text>
<rect class="d-box w" x="250" y="209" width="160" height="34" rx="5"/>
<text class="d-label" x="330" y="230" text-anchor="middle">BEGIN</text>
<rect class="d-box w" x="250" y="261" width="160" height="34" rx="5"/>
<text class="d-label" x="330" y="282" text-anchor="middle">UPDATE price = 20</text>
<rect class="d-box w" x="250" y="313" width="160" height="34" rx="5"/>
<text class="d-label" x="330" y="334" text-anchor="middle">COMMIT</text>
<path class="d-link" d="M 240 386 H 412"/>
<path class="d-arrow" d="M 421 386 L 412 381.5 L 412 390.5 Z"/>
<text class="d-emph" x="252" y="378">still reads v1</text>
<rect class="d-box r key" x="46" y="365" width="190" height="34" rx="5"/>
<text class="d-label" x="141" y="386" text-anchor="middle">SELECT → price = 10</text>
<rect class="d-box r" x="46" y="417" width="190" height="34" rx="5"/>
<text class="d-label" x="141" y="438" text-anchor="middle">COMMIT — snapshot ends</text>
</svg>
<figcaption>A reader and a writer touching the same row without ever blocking each other. Transaction 1 reads <code>v1</code> for its entire lifetime, while Transaction 2 writes <code>v2</code> alongside it.</figcaption>
</figure>

**Key concepts:**

- Transaction 1 gets a *snapshot* of the database as of T1.
- Transaction 2's write creates a **new** version (`v2`) rather than overwriting in place.
- The old version (`v1`) is retained because Transaction 1 can still see it.
- Transaction 1 therefore reads `v1` consistently, from T1 through to its commit.
- No locks are involved — readers never block writers, and writers never block readers.
- Once both transactions have committed, `v1` is unreachable and can be garbage collected.
